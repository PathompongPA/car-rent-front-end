...
let style = {
    container: cva(""),
    btnLanguage: {
        container: cva(" flex flex-row px-4 py-2 gap-1 rounded-4xl  text-blue-1 hover:bg-blue-1 hover:text-white hover:cursor-pointer duration-600 relative", {
            variants: {
                isOpen: {
                    true: " ",
                    false: ""
    ...
    option: {
        container: cva(" px-1 gap-1 bg-white text-blue-1 shadow-2 top-full mt-2 rounded-2xl flex flex-col w-full  duration-600 ", {
            variants: {
                isOpen: {
                    true: " max-h-fit py-1 ",
                    false: "max-h-0"
        ...
        item: cva(" rounded-4xl  p-1 hover:bg-black/25 hover:text-white hover:cursor-pointer duration-300", {
            variants: {
                isOpen: {
                    true: "",
                    false: ""
